                ...
                <div className="container w-full px-[15px] mx-auto sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px]">
                    <div className="row flex flex-wrap mr-[-15px] ml-[-15px]">
                        ...
                        <div className="col px-0 basis-full max-w-full">
                            <div className="container w-full px-[15px] mx-auto sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1140px] mb-[50px]">
                    ...
                    <div className="row flex flex-wrap mr-[-15px] ml-[-15px] mb-12">
