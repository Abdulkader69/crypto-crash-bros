    ...
    <div className='team-section'>
        <div className="max-w-[1132px] m-auto px-4 pt-12 mt-12 border-t border-solid border-Border">
            ...
            <div className="row py-12">
                <p className='text-sm md:text-base uppercase text-white font-semibold text-center'>VERIFIED SMART CONTRACT ADDRESS: <a className='text-Brand underline break-words' target="_blank" rel="noreferrer" href="https://etherscan.io/address/0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D">0xBC4CA0EdA7647A8aB7C2061c2E118A18a936f13D</a></p>
            </div>
        </div>
    </div>
  )
